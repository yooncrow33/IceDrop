...
public class SkillManager {
    ...
    public SkillManager(ISkillPointManager is) {
        this.is = is;
    }
    ...
    public void upgradeItemCoolTime() {
        ...
        if (skillPoint > 0) {
            ...
            skillPointUsed ++;
            itemCoolTimeLevel++;
            is.addInfo("upgraded!","current Level : " + itemCoolTimeLevel, "present xp : " + xp);
        } else {
            is.addStrEffect("Not enough skill point!");
        }
    }
    ...
    public void upgradeClickOffset() {
        ...
        if (skillPoint > 0) {
            ...
            skillPointUsed ++;
            clickOffsetLevel++;
            is.addInfo("upgraded!","current Level : " + clickOffsetLevel, "present xp : " + xp);
        } else {
            is.addStrEffect("Not enough skill point!");
        }
    }

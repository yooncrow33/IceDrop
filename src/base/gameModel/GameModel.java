...
import base.gameModel.ice.IIceManager;
import base.gameModel.ice.IceManager;
import base.gameModel.quest.IQuestManager;
import base.gameModel.quest.QuestManager;
import base.gameModel.quest.object.IQuest;
import base.gameModel.shop.IShopManager;
import base.gameModel.shop.ShopManager;
import base.gameModel.skill.ISkillPointManager;
import base.gameModel.skill.SkillManager;
import base.gameModel.tap.TapManager;
...
public class GameModel implements IGameModel, IGameModelTick, IGameModelQuest, IGameModelShop, IGameSkillPoint, IInfo, IIceManager, ISkillPointManager, IShopManager, IQuestManager {
    ...
    public GameModel(int profileId, IMouse iMouse) {
        ...
        iceManager = new IceManager(this,this,iMouse);
        tapManager = new TapManager(this);
        skillManager = new SkillManager(this);
        shopManager = new ShopManager(this,this,this);
        questManager = new QuestManager(this,this);
    }
    ...
    @Override public int getThirdQuestProgress() { return (lastIceBasicCollectCount + iceManager.getIceBasicCollectedCount()); }

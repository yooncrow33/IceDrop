...
// 복구
        ...
        g.drawString("FROZEN FIELD", 40, 60);

        g.setFont(new Font("Arial", Font.PLAIN, 14));
        g.setColor(new Color(120, 160, 200));
        g.drawString("Collect the ice. Control the flow.", 40, 80);
// 버전 정보 (구석으로 이동 & 투명도 활용)
        ...
        g.drawString("v1.13.3-alpha", 20, VIRTUAL_HEIGHT - 30);
        // 화면 왼쪽 아래 끝
    ...
    public void renderBaseFrame(Graphics g) {
        ...
        g.setColor(black);
        g.fillRect(0,1070,1920,320);
        g.fillRect(0,- 310,1920,320);

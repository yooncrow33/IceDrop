...
public class QuestManager implements IQuest {
    ...
    public QuestManager(IQuestManager iq, IInfo iInfo, Lang l) {
        this.l = l;
        firstQuest = new Quest(iInfo, this, l);
        secondQuest = new Quest(iInfo, this, l);
        thirdQuest = new LongTimeQuest(iInfo, this, l);
    ...
    public void refreshQuests() {
        if (iq.getShopManager().getCoin() >= 400) {
            ...
            firstQuest = new Quest(iInfo, this, l);
            secondQuest = new Quest(iInfo, this, l);
            iq.getEffectManager().addInfo(l.getQuestRefreshedMsg(), "- 400", l.getSKillPresentCoin() + iq.getShopManager().getCoin());
        } else {
            iq.getEffectManager().addStrEffect(l.getQuestNotEnoughMoneyMsg());
        }
